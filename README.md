...
- **Advanced Filtering System**: Airbnb-style filter modal with price range, property types, guest capacity, rooms/beds/bathrooms, amenities, and instant book options.
